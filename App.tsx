...
export default function App() {
  ...
  return (
    <div className={`flex h-screen w-full font-sans overflow-hidden transition-colors duration-300 ${theme === 'dark' ? 'bg-[#09090b] text-gray-100' : 'bg-gray-100 text-gray-900'}`}>
      ...
      <div className={`${sidebarOpen ? 'w-72' : 'w-16'} ${theme === 'dark' ? 'bg-[#0e0e11] border-white/10' : 'bg-white border-gray-200'} border-r flex flex-col transition-all duration-300 shrink-0`}>
      ...
      <div className={`w-[400px] border-l flex flex-col shadow-2xl z-20 shrink-0 ${theme === 'dark' ? 'bg-[#111116] border-white/10' : 'bg-white border-gray-200'}`}>
        <ChatInterface 
          messages={messages}
